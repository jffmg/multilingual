<main class="main">
    ...
    <p><?php echo BLABLAPORTFOLIO; ?></p>
    <article>
        <p class="date toggle5">
            <img src="img/mastertcloc.jpg" alt="Site du Master TCLoc" class="screencap"></p>
        <span class="toggle toggle5 real"></span>
        <p class="xp vue5"><a href="http://www.mastertcloc.unistra.fr/" target="_blank"><?php echo MASTERTCLOC; ?></a></p>
    </article>
    <article class="pair">
        <p class="date toggle6">
