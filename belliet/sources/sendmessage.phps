...
{
    $destinataire = 'juliette.malgouyard@etu.unistra.fr';
    $nom = $_POST["nom"];
    $prenom = $_POST["prenom"];
    ...
    if (mail($destinataire,$objet,$message,$entete))
        ...
        echo '<a href="https://etudiants-caweb.u-strasbg.fr/1617/jmalg/minisite/index.php?page=contact&css='.$css.'&titre='.$titre.' id="retourform">Retour</a>';
        }
    else 
        { 
        echo 'Un probl&eagrave;me s\'est produit lors de l\'envoi du message.';
        echo '<a href="https://etudiants-caweb.u-strasbg.fr/1617/jmalg/minisite/index.php?page=contact&css='.$css.'&titre='.$titre.'>Nouvelle tentative&nbsp;?</a>';
        }
}
?>